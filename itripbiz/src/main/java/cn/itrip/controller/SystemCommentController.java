...
public class SystemCommentController {
    ...
    @Resource private ValidationToken validationToken;
    ...
    public Dto<Object> getHotelScore(@ApiParam(required = true, name = "hotelId", value = "酒店ID")
        ...
        if(null != hotelId && !"".equals(hotelId)){
            ...
            try {
                itripScoreCommentVO =  commentService.getAvgAndTotalScore(Long.valueOf(hotelId));
    ...
    public Dto<Object> getCommentList(@RequestBody ItripSearchCommentVO itripSearchCommentVO){
        ...
        try{
            Page page = commentService.queryItripCommentPageByMap(param,
    ...
    public Dto<Object> addComment(@RequestBody ItripAddCommentVO itripAddCommentVO, HttpServletRequest request){
        ...
        if(null != currentUser && null != itripAddCommentVO){
            ...
            List<Image> itripImages = null;
            Comment itripComment = new Comment();
            ...
            try {
                if(itripAddCommentVO.getIsHavingImg() == 1 ){
                    itripImages = new ArrayList<Image>();
                    //loop input imgs array
                    int i = 1;
                    for (Image itripImage : itripAddCommentVO.getItripImages()) {
                ...
                commentService.itriptxAddItripComment(itripComment,(null == itripImages?new ArrayList<Image>():itripImages));
