...
import cn.itrip.trade.wx.SignType;
...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            //根据订单编号查询订单详情对象信息。
            HotelOrder order = orderService.loadItripHotelOrder(orderNo);
            //1、构造参数
            ...
            //异步通知的URL地址。
            data.put("notify_url", "http://itripyfd.free.idcfengye.com/itriptrade/api/wx/notify");
           ...
           // data.put("appid", "wxab8acb865bb1637e");//appid暂时用的是测试用的appid
            ...
            String reqXml = WXPayUtil.generateSignedXml(data, wxConfig.getKey(),SignType.HMACSHA256);


            //2、转成XML请求微信支付平台   key为:  API密钥
            //String reqXml = WXPayUtil.generateSignedXml(data, "2ab9071b06b9f739b950ddb41db2690d", SignType.HMACSHA256);
    ...
    public void wxNotify(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            boolean flag = WXPayUtil.isSignatureValid(resultMap, "2ab9071b06b9f739b950ddb41db2690d ",SignType.HMACSHA256);
            //2、识别签名是否成功，修改订单状态
            if (flag) {  //签名是正确的。
